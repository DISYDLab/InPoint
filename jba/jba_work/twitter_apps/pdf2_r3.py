...
#print(sys.path)
# import mypy
# import credentials from twitter
from config import *
import tweepy
import datetime
import logging
...
tweets_list = tweepy.Cursor(api.search, q=['CoffeeIsland OR coffee Island'],since= str(since), until=str(until),tweet_mode='extended', lang='en').items(30)
