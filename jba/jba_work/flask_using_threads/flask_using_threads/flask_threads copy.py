...
#spark_set = False
#print (f'spark_set: {spark_set}')



#if spark_set == False :    
#    spark, spark_set = start_spark()
# **************************************************************************************************************************
# @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
# **************************************************************************************************************************
...
#app.before_first_request(set_api)
...
#def start_spark():
    #spark  = SparkSession \
        ...
        #.config("spark.scheduler.mode","FAIR") \
        #.config("spark.scheduler.allocation.file", "/opt/spark/conf/fairscheduler.xml") \
        #.config("PYSPARK_PIN_THREAD", 'true') \
        #.getOrCreate()
    #return spark
...
#We can also pass the SparkSession object to multiple threads so that each thread can create their own spark jobs.
